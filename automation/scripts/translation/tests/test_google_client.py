...
def test_translate_texts_basic():
    """translate_texts sends text to Google and returns translations."""
    mock_translator = MagicMock()
    mock_result1 = MagicMock()
    mock_result1.text = "Hola, mundo!"
    mock_result2 = MagicMock()
    mock_result2.text = "Esto es una prueba."
    mock_translator.translate.return_value = [mock_result1, mock_result2]
...
def test_translate_texts_single():
    """translate_texts handles single result (not list) from Google."""
    mock_translator = MagicMock()
    mock_result = MagicMock()
    mock_result.text = "Hola"
    mock_translator.translate.return_value = mock_result  # single, not list
...
def test_translate_srt_cues():
    ...
    mock_translator.translate.return_value = [mock_r1, mock_r2]
